/**
    ...
    OWASP ASVA  https://owasp.org/www-project-application-security-verification-standard/ (v4.0.1 is the latest as of this package release)
...
module.exports = function isPasswordValid(password){
    ...
    function isPasswordCommon(password){
        // Checks password against OWASP ASVA v4. 2.1.7 / NIST 5.1.1.2 / CWE-521
        const passwords = [
            'password',
            '123456',
            '12345678',
    ...
    const lengthCheck = isPasswordShort(password)
    const commonCheck = isPasswordCommon(password)

    if(!lengthCheck && !commonCheck){
        return {passed: true}
    } else {
        return {
            passed: false,
            tooShort: lengthCheck,
            tooCommon: commonCheck
        }
    }
}